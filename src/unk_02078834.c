...
const u8 _0210125C[] = {0x03, 0x04, 0x04, 0x04};
...
BOOL sub_02078834(TaskManager* taskManager) {
    ...
    switch (temp_r0->unk4) {
    case 0: 
        temp_r0->unk0->unk0 = fieldSystem->saveData;
    case 1: 
        temp_r0->unk4++;
        if ((temp_r0->unk0->unk4 == 1) && (sub_0203A05C(fieldSystem->saveData) != 0)) {
            temp_r0->unk4 = 0xAU;
            temp_r0->unk8[0] = 0;
        }
        break;
    case 2: 
        CallApplicationAsTask(taskManager, &_02101290, temp_r0->unk0);
        temp_r0->unk4++;
        break;
    case 3: 
        ...
        break;
    case 4: 
        CallTask_02050960(taskManager, temp_r0->unk0->unk8, temp_r0->unkC, temp_r0->unkD);
        temp_r0->unk4++;
        break;
    case 5: 
        temp_r0->unk4 = 2;
    ...
    case 10:
    case 11:
        Heap_Free(temp_r0->unk0);
        Heap_Free(temp_r0);
        temp_r0->unk4++;
        return 1;
    case 12:
        sub_020378E4(0);
        temp_r0->unk10 = sub_020968B0(fieldSystem, NULL);
        temp_r0->unk4++;
        break;
    case 13:
        if (FieldSystem_ApplicationIsRunning(fieldSystem) == 0) {
            Heap_Free(temp_r0->unk10);
            temp_r0->unk4 = 2;
        }
        break;
    case 14:
    ...
    case 15:
        ...
        break;
    case 16:
        temp_r0->unk10 = sub_02078C18(fieldSystem, HEAP_ID_FIELD2, temp_r0->unk14);
        temp_r0->unk4++;
        break;
    case 17:
        if (FieldSystem_ApplicationIsRunning(fieldSystem) == 0) {
            temp_r0->unk4 = 2;
            sub_02078C60(temp_r0->unk10);
        }
        break;
    case 18:
    ...
    case 19:
        ...
        break;
    case 20:
        temp_r0->unk10 = sub_02078C74(fieldSystem, HEAP_ID_FIELD2, temp_r0->unk14);
        temp_r0->unk4++;
        break;
    case 21:
        if (FieldSystem_ApplicationIsRunning(fieldSystem) == 0) {
            temp_r0->unk4 = 2;
            sub_02078CB4(temp_r0->unk10);
        }
        break;
    case 22:
    ...
    case 23:
        ...
        break;
    case 24:
        temp_r0->unk10 = sub_02078CC8(fieldSystem, HEAP_ID_FIELD2, temp_r0->unk14);
        temp_r0->unk4++;
        break;
    case 25:
        if (FieldSystem_ApplicationIsRunning(fieldSystem) == 0) {
            temp_r0->unk4 = 2;
            sub_02078D10(temp_r0->unk10);
        }
        break;
    default:
        return 1;
...
UnkStruct_sub_02078834* sub_02078B2C(void) {
    ...
    UnkStruct_sub_02079352* temp_r0_2 = Heap_AllocAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_sub_02079352));
    temp_r0->unk0 = temp_r0_2;
    MI_CpuFill8(temp_r0_2, 0, sizeof(UnkStruct_sub_02079352));
    return temp_r0;
}
...
void sub_02078B9C(UnkStruct_sub_02078834* arg0, FieldSystem* fieldSystem, enum HeapID arg2, s32 arg3) {
    UnkStruct_sub_02078B9C* temp_r0 = Heap_Alloc(arg2, 0xC);
    temp_r0->unk0 = arg3;
    temp_r0->unk1 = 2;
...
s32 sub_02078BD8(UnkStruct_sub_02078834* arg0) {
    UnkStruct_sub_02078B9C* temp_r0 = arg0->unk10;
    if (temp_r0->unk3 == 1) {
        switch (temp_r0->unk0) {
        case 1:
            arg0->unk4 = 0x10;
...
UnkStruct_sub_02078C18* sub_02078CC8(FieldSystem* fieldSystem, enum HeapID arg1, s32 arg2) {
    UnkStruct_sub_02078C18* temp_r0 = Heap_Alloc(arg1, 0x3CU);
